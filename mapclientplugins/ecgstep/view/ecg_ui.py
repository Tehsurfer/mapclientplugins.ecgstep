...
class Ui_MeshGeneratorWidget(object):
    def setupUi(self, MeshGeneratorWidget):
        ...
        MeshGeneratorWidget.resize(928, 789)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 472, 364))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.tessellationBox = QtGui.QGroupBox(self.dockWidgetContents)
        self.tessellationBox.setObjectName("tessellationBox")
        self.horizontalLayout = QtGui.QHBoxLayout(self.tessellationBox)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.tessellation_spinBox = QtGui.QSpinBox(self.tessellationBox)
        self.tessellation_spinBox.setMinimum(1)
        self.tessellation_spinBox.setMaximum(24)
        self.tessellation_spinBox.setProperty("value", 8)
        self.tessellation_spinBox.setObjectName("tessellation_spinBox")
        self.horizontalLayout.addWidget(self.tessellation_spinBox)
        self.verticalLayout.addWidget(self.tessellationBox)
        ...
        self.pushButton_2 = QtGui.QPushButton(self.blackfynn_groupBox)
    ...
    def retranslateUi(self, MeshGeneratorWidget):
        ...
        self.tessellationBox.setTitle(QtGui.QApplication.translate("MeshGeneratorWidget", "Set Tessellation", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pushButton_2.setText(QtGui.QApplication.translate("MeshGeneratorWidget", "Upload to Blackfynn", None, QtGui.QApplication.UnicodeUTF8))
